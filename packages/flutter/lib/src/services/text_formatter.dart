...
/// A [TextInputFormatter] that prevents the insertion of more user-perceived
/// characters (i.e. grapheme clusters) than allowed.
///
...
class LengthLimitingTextInputFormatter extends TextInputFormatter {
  ...
  /// The limit on the number of user-perceived characters (i.e. grapheme
  /// clusters) this formatter will allow.
  ///
